...
### To view the `/admin` page, login as the admin user: `admin:admin` 
### default "auctioneer" user login: `auctioneer:password123!` (this usergroup can start / close auctions)